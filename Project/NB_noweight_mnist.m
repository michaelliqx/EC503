function [result_train_naive,result_test_naive,train_label_naive,test_label_naive] = NB_noweight_mnist(new_train,new_label,new_test,test_label)
%importing data
%%%
...
result_train = ClassLabel(max_ind_train);
